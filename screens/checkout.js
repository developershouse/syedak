...
export default class Checkout extends Component {
  ...
  render() {
    ...
    const { total, products, couponPercent } = this.props.navigation.state.params;
    let discount = 0;
   ...
   // const discount = this.state.discount;
    ...
    if (total >= 899) 
        shipping = 0;
    if (couponPercent > 0 )
      discount += total*couponPercent/100;
      ...
      <Container>
        ...
        <Content style={styles.content}>
          ...
          <View style={{backgroundColor: "#ddd", marginHorizontal: 8, marginVertical: 14, padding: 8}}>
            ...
            {(Total >= 899) ? (<View style={{marginBottom: 5}}><Text style={{fontWeight: "400", fontSize: 14}}>(Shipping fee is waved for orders over $899)</Text></View>) : null }
            ...
            {(couponPercent > 0) ? (<View style={{marginBottom: 5}}><Text style={{fontWeight: "400", fontSize: 14}}>(You recieved ${couponPercent}% off your purchase)</Text></View>) : null }
