        ...
        <Header style={styles.header}>
          <Left>
            <View style={{flexDirection: "row"}}>
              <Icon
                style={[styles.white, {fontSize: 35,width:40}]}
						...
						>
							{images.map((image, i) => (
								<TouchableHighlight
									...
									key={i} style={{ backgroundColor: "#fff"}}>
              ...
              renderHeader={() =>
                <TouchableWithoutFeedback>
                  <Icon onPress={() => this.setState({ fullscreen: false, selectedImg: null })}
                        style={{color: 'white', position:'absolute', top:30, left:20, zIndex:100, fontSize: 35,shadowOffset:{  width: 1,  height: 1 },
