...
import { Text, View, StyleSheet, AsyncStorage, Platform, TouchableOpacity, StatusBar, Image, TextInput } from 'react-native'
...
export default class Account extends Component {
  ...
  render() {
    const { loading, user: { name, username, email, image, orders, adress} } = this.state;
    return (
      <>
        ...
        (<>
          ...
          <View style={{
            ...
            <View style={{flexDirection: 'row',flex:3}}>
              ...
              <View style={{marginLeft: 12,flexGrow:2}}>
              <TextInput
                  placeholder={'Name'}
            ...
            <View style={{flexDirection:'column',alignItems:'center'}}>
              <Icon
                  style={[styles.black, {fontSize: 40}]}
