...
import { Container, Header, Content, ListItem, Item, Input, Icon, Left, Body, Right, List, Spinner, Button } from 'native-base'
      ...
      <Content>
        ...
        (<>
          ...
          <View style={{
            ...
            <Icon
                style={[styles.black, {fontSize: 30}]}
        ...
        <Button onPress={() => {this.props.navigation.navigate("Contact")
                ...
                <Icon
                style={[styles.white, {fontSize: 20}]}
                name={Platform.OS === "ios" ? "ios-call" : "md-call"}
                // onPress={() => {this.props.navigation.navigate("Contact")
                // }}
              />
                <Text style={[styles.white,{fontSize:20}]}>Contact Us</Text>
              </Button>
      </Content>
      </Container>
      </>
